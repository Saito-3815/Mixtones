  ...
  describe 'POST /api/v1/sessions/password' do
    ...
    context 'when user exists and password is correct' do
      it 'returns a success status' do
        post '/api/v1/sessions/password', params: { user: { email: 'test@example.com', password: 'password', isPersistent: 'false' } }
        expect(response).to have_http_status(:ok)
      end
    ...
    context 'when user does not exist' do
      it 'returns a not found status' do
        post '/api/v1/sessions/password', params: { user: { email: 'nonexistent@example.com', password: 'password', isPersistent: 'false' } }
    ...
    context 'when password is incorrect' do
      it 'returns an unauthorized status' do
        post '/api/v1/sessions/password', params: { user: { email: 'test@example.com', password: 'wrongpassword', isPersistent: 'false' } }
