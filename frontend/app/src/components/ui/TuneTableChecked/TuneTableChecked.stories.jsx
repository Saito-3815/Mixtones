// TuneTableChecked.stories.jsx
import React from "react";
import { TuneTableChecked } from "./TuneTableChecked";

export default {
  title: "TuneTableChecked",
  component: TuneTableChecked,
};

const Template = (args) => <TuneTableChecked {...args} />;
