  ...
  return (
    <div className="container flex flex-col bg-theme-black max-w-[890px] h-full mx-auto my-8 rounded-sm justify-center items-center overflow-hidden">
      <div className="w-full max-w-[550px] mx-auto items-center text-white my-8">
        <div className="my-8">
          <p>
            この利用規約（以下、「本規約」といいます。）は、Mixtones（以下、「当方」といいます。）がこのウェブサイト上で提供するサービス（以下、「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下、「ユーザー」といいます。）には、本規約に従って、本サービスをご利用いただきます。
          </p>
        </div>
        <div className="text-theme-gray text-sm">
          <h2 className="text-xl text-white mt-4">第1条（適用）</h2>
          ...
          <h2 className="text-xl text-white mt-4">第2条（利用登録）</h2>
          <ol className="list-decimal pl-5">
            <li>
          ...
          <h2 className="text-xl text-white mt-4">第4条（禁止事項）</h2>
          <p>
          ...
          <h2 className="text-xl text-white mt-4">第7条（退会）</h2>
          <p>
          ...
          <h2 className="text-xl text-white mt-4">第10条（利用規約の変更）</h2>
          <ol className="list-decimal pl-5">
            <li>
          ...
          <h2 className="text-xl text-white mt-4">第12条（通知または連絡）</h2>
          <p>
